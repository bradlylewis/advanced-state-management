...
Context API provides the props to any component that needs it without having to drill for props.

2. In your own words, describe `actions`, `reducers` and the `store` and their role in Redux. What does each piece do? Why is the store known as a 'single source of truth' in a redux application?

You want to store all of your state in 'store' and your reducers are how your components handle the payload and map out the states. The actions are the functions that do the work behind the scene.

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

This allows us to applyMiddleware and write action components that return functions instead of actions.

4. What is your favorite state management system you've learned and this sprint? Please explain why!

I really like redux and don't mind having to drill for props. 
